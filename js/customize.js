...
(function () {
  ...
  //廣告輪播
  const linkSwiper = new Swiper('.linkSection .swiper', {
    slidesPerView: 1,
    spaceBetween: 30,
    loop: false,
    // 切換點
    ...
    // 切換箭頭
    navigation: {
      nextEl: '.linkSection .nextSlider', //自行設定樣式
      prevEl: '.linkSection .prevSlider', //自行設定樣式
      disabledClass: 'swiperArrow-disabled', //不可點選樣式
    },
    breakpoints: {
      500: {
  ...
  //np輪播
  const npSwiper = new Swiper('.npMenu .swiper', {
    slidesPerView: 2,
    spaceBetween: 30,
    loop: false,
    ...
    navigation: {
      ...
      prevEl: '.npMenu .prevSlider', //自行設定樣式
      disabledClass: 'swiperArrow-disabled', //不可點選樣式
    },
    breakpoints: {
      500: {
